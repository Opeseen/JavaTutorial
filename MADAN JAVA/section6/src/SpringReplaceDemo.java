public class SpringReplaceDemo {
  public static void main(String[] args) {
    ...
    String replaceString4 = originalString2.replaceAll("a|e|i|o|u", "*");

    String originalString3 = "apple orange apple banana apple";
    String replaceString5 = originalString3.replaceFirst("apple", "grape");
  }
}
